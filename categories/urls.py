...
from .views import CategoryListView, CityBoardListView, PinnedMessageByCityView, PinnedMessageListView, CreatePinnedMessageView, DeactivatePinnedMessageView
